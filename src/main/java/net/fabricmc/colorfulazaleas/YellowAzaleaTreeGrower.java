...
public class YellowAzaleaTreeGrower
    ...
    protected Holder<? extends ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource random, boolean largeHive) {
        return BuiltinRegistries.CONFIGURED_FEATURE
                .getResourceKey(ColorfulAzaleaTreeFeatures.YELLOW_AZALEA_TREE).flatMap(BuiltinRegistries.CONFIGURED_FEATURE::getHolder)
