...
public class OrangeAzaleaBlock extends SaplingBlock implements BonemealableBlock {
    private static final VoxelShape SHAPE = Shapes.or(Block.box(0.0, 8.0, 0.0, 16.0, 16.0, 16.0), Block.box(6.0, 0.0, 6.0, 10.0, 8.0, 10.0));

    public OrangeAzaleaBlock(BlockBehaviour.Properties properties) {
        super(new OrangeAzaleaTreeGrower(), properties);
    }
